...
Enemy::Enemy(char _name[], int _health, int _initialHealth, int _attack, int _defense, int _speed, int _experience, int _id) : Character(_name, _health, _initialHealth, _attack, _defense, _speed, false) {
