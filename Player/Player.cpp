...
Player::Player(char _name[], int _health, int _initialHealth, int _attack, int _defense, int _speed) : Character(_name, _health, _initialHealth, _attack, _defense, _speed, true) {
    level = 1;
    experience = 0;
}

Player::Player(char *_name, int _health, int _initialHealth, int _attack, int _defense, int _speed, bool _isPlayer, int _level, int _experience) : Character(_name, _health, _initialHealth, _attack, _defense, _speed, _isPlayer){
    level = _level;
...
Player* Player::unserialize(char* buffer) {
    ...
    return new Player(name, health, initialHealth, attack, defense, speed, isPlayer, level, experience);
}